...
export default {
  ...
  data () {
    return {
      activeUser: { ...this.user } // Biar pas disave aja baru ganti usernya
    }
  },
  computed: {
    userThreadsCount () {
  ...
  methods: {
    save () {
      ...
      // this.activeUser : setiap save pertama, kemudian diubah lagi dan bakal yg kayak cuman this.user aja

      this.$router.push({ name: 'Profile' }) // go to profile
    },
    cancel () {
